...
<html lang="en">
    ...
    <head>
        ...
        <title>View Bookings Of Customer</title>
                            ...
                            <div class="col-sm-12">
                                <div class="home-tab">
                                    ...
                                    <div class="col-12 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title text-center">View Bookings Of Customer: <c:if test="${customer != null}">${customer.customerName}</c:if><c:if test="${customer == null}">CustomerID = ${customerId} does not exist.</c:if></h4>     
                                                <div class="row">   
                                                    <div class="col-sm-12 mt-2" >
                                                        ...
                                                        <p class="text-center mt-2">
                                                                <a  href="<c:url value="/admin/customers" />" class="btn btn-dark" style="color: white;"><i class="fas fa-backward"></i> Back to List Customers</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
